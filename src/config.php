 ...
 * Inline config.php
 *
 * Completely optional configuration settings for Inline if you want to customize some
 * of its more esoteric behavior, or just want specific control over things.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'inline.php' and make
 * your changes there.
 *
